                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <textarea type="text" id="alamat" class="form-control"
                                                                  name="alamat" rows="3"
                                                                  required>{{ $d->pasien_alamat }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <label class="form-label" for="alamatkerja">Alamat
                                                            Pekerjaan<sup class="text-danger">*</sup></label>
                                                        <textarea type="text" id="alamatkerja" class="form-control"
                                                                  name="alamatkerja" rows="4"
                                                                  required>{{ $d->pasien_kerja_alamat }}</textarea>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mt-2">
                                                        ...
                                                        <textarea id="catatanKhusus" class="form-control"
                                                                  name="catatankhusus" placeholder="Catatan Khusus"
                                                                  rows="3"
