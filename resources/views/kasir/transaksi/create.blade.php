            ...
            <div class="card-body" id="konten">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3" style="margin-top:30px;">
                        <button type="button" id="addMore" class="btn btn-success btn-sm fw-bold" disabled><span
                                class="tf-icons bx bxs-cart-add mb-1"></span>&nbsp; Add
                        </button>
                    </div>
                ...
                dataRows.forEach(row => {
                    const newRow = `
                                    <tr>
                                        ...
                                        <td><button type="button" id="removeLayanan" class="btn btn-icon btn-danger btn-sm removeLayanan"><span class="tf-icons bx bx-trash"></span></button></td>
                                    </tr>
                                `;
