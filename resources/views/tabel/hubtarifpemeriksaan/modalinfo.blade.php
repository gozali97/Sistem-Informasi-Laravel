            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="tarif_kelompok" class="form-label">Nama Test Pemeriksaan</label>
                            <input type="text" id="tarif_nama" value="" name="tarif_nama"
                                   class="form-control" placeholder="Nama Test Pemeriksaan" disabled>

                        </div>

                        <div class="mt-3">
                            <label for="tarif_nama" class="form-label">Tipe Layanan</label>
                            <input type="text" id="tarif_tipe" value="" name="tarif_tipe"
                                   class="form-control" placeholder="Nama Test Pemeriksaan" disabled>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input type="number" id="tarif_jalan" value=""
                                   name="tarif_jalan" class="form-control" placeholder="Tarif" disabled>
                        </div>

                        <div class="mt-3">
                            <label for="tarif_status" class="form-label">Status</label>
                            <input type="text" id="tarif_status" value=""
                                   name="tarif_status" class="form-control" placeholder="Tarif" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
