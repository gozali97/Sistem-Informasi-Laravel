...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">Sepertinya Anda Tersesat :(</h2>
            <p class="mb-4 mx-2">Oops! 😖 Silahkan login ulang agar dapat mengakses halaman.</p>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-primary">Back to login</button>
            </form>
            <div class="mt-3">
                <img src="{{ url('/assets/img/illustrations/403.png') }}" alt="page-misc-error-light" width="500"
