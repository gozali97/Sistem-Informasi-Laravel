<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Layanan Laboratorium</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('layananlab.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2">
                            <label for="nilai" class="form-label">Nilai Layanan<sup
                                    class="text-danger">*</sup></label>
                            <input type="number" id="nilai" value="{{ old('nilai') }}" name="nilai"
                                   class="form-control" placeholder="Nilai" required>
                        </div>
                        <div class="mt-2">
                            <label for="nilai_lama" class="form-label">Nilai Lama Layanan<sup
                                    class="text-danger">*</sup></label>
                            <input type="number" id="nilai_lama" value="{{ old('nilai_lama') }}" name="nilai_lama"
                                   class="form-control" placeholder="Nilai lama" required>
                        </div>
                        <div class="mt-2">
