<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Ubah Informasi</h4>

    <!-- Basic Bootstrap Table -->
    <div class="card">
        <div class="card-header">

            <a href="{{ route('informasi.index') }}" type="button" class="btn btn-outline-secondary mt-3">
                Kembali
            </a>
        </div>

        <form id="myForm" action="{{ route('informasi.update', $data->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input type="text" id="judul" value="{{ $data->judul_informasi }}" name="judul"
                                   class="form-control" placeholder="Judul" required>
                        </div>
                        <div class="mt-2">
                            <label for="informasi" class="form-label">Informasi<sup class="text-danger">*</sup></label>
                            <textarea type="text" id="informasi" name="informasi" class="form-control"
                                      placeholder="informasi" required>{{ $data->informasi }}</textarea>
                        </div>
                        <div class="mt-2">
                            <label for="url" class="form-label">Url<sup class="text-danger">*</sup></label>
                            <input type="text" id="url" value="{{ $data->alamat_url }}" name="url"
                    ...
                    <div class="col-md-5">
                        ...
                        <img id="preview" class="mt-4 rounded" src="{{ url($data->path_gambar) }}" alt=""
