<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Informasi</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('informasi.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea type="text" id="informasi" name="informasi" class="form-control"
                                      placeholder="informasi" required>{{ old('informasi') }}</textarea>
                        </div>
                        <div class="mt-2">
