<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span>Tambah Tarif Laboratorium</h4>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-3">
                            <label for="tarif_nama" class="form-label">Nama Test Pemeriksaan<sup
                                    class="text-danger">*</sup></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label for="tarif_jalan" class="form-label">Tarif<sup
                                            class="text-danger">*</sup></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    <label for="tarif_status" class="form-label">Status<sup
                                            class="text-danger">*</sup></label>
                                    <select name="tarif_status" class="form-control" id="tarif_status" required>
                                        <option value="">--Pilih--</option>
                                        <option value="A" {{ old('tarif_status') == 'A' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="N" {{ old('tarif_status') == 'N' ? 'selected' : '' }}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                                </div>
