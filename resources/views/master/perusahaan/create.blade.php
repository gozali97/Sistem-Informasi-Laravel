<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Perusahaan</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('perusahaan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                            ...
                            <select name="kode" id="kode" class="form-control" required>
                                ...
                                @foreach ($pengirim as $p)
                                    <option value="{{ $p->grup_kode }}"
                                        {{ old('kode') == $p->grup_kode ? 'selected' : '' }}>{{ $p->grup_nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
