<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Ubah Layanan Hilab</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('layananhilab.update', $data->id) }}" method="POST"
