<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah TTD Dokter</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('ttddokter.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                        ...
                        <div>
                            ...
                            <select class="form-control" id="dokter" name="dokter" required>
                                ...
                                @foreach ($dokter as $data)
                                    <option value="{{ $data->dokter_kode }}">{{ $data->dokter_nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="col-md-4 ml-5">
                        <div>
                            <label for="formFile" class="form-label">Tanda Tangan Dokter<sup
                                    class="text-danger">*</sup></label>
