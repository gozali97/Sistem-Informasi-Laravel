<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Ubah Syarat & Ketentuan</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('syaratketentuan.update', $data->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input type="text" id="judul" value="{{ $data->judul_syarat_ketentuan }}"
                                   name="judul" class="form-control" placeholder="Judul" required>
                        </div>
                        <div class="mt-2">
                            <label for="url" class="form-label">Kategori<sup class="text-danger">*</sup></label>
                            <select name="kategori" id="kategori" class="form-control" required>
                                <option value="">-- Pilih --</option>
                                <option value="0" {{ $data->kategori_nama == 0 ? 'selected' : '' }}>Akun</option>
                                <option value="1" {{ $data->kategori_nama == 1 ? 'selected' : '' }}>Pembayaran
                                </option>
                                <option value="2" {{ $data->kategori_nama == 2 ? 'selected' : '' }}>Profil</option>
                            </select>
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea type="text" id="konten" name="konten" class="form-control"
                                      placeholder="Syarat dan Ketentuan" rows="6"
                                      required>{{ $data->syarat_ketentuan_value }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div>
