<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Paket Laboratorium</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('paketlab.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
