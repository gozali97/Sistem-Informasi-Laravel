<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Ubah Layanan Test Detail
        Laboratorium
    </h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('layanantestdetail.update', $data->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                            ...
                            <select name="nama" id="nama" class="form-control">
                                ...
                                @foreach ($layanan as $l)
                                    <option value="{{ $l->var_kode }}"
                                        {{ $data->tarif_kelompok == $l->var_kode ? 'selected' : '' }}>
                                        {{ $l->var_nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mt-2">
                            <label for="detail" class="form-label">Nama Tes Detail<sup
                                    class="text-danger">*</sup></label>
                            <input type="text" id="detail" value="{{ $data->tarif_nama }}" name="detail"
                        ...
                        <div class="mt-2">
                            ...
                            <select name="tipe" class="form-control" id="tipe" required>
                                <option value="">--Pilih--</option>
                                <option value="Single" {{ $data->tarif_tipe == 'Single' ? 'selected' : '' }}>Single
                                </option>
                                <option value="Multiple" {{ $data->tarif_tipe == 'Multiple' ? 'selected' : '' }}>
                                    Multiple
                                </option>
                            </select>
                        </div>
                        <div class="mt-2">
                            <label for="tarif" class="form-label">Tarif Layanan<sup
                                    class="text-danger">*</sup></label>
                            <input type="number" id="tarif" value="{{ $data->tarif_jalan }}" name="tarif"
                    ...
                    <div class="col-md-6">
                        ...
                        <img id="preview" class="mt-4 rounded"
                             src="{{ asset($data->path_gambar) }}" alt=""
