<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Lokasi Hilab</h4>
    ...
    <div class="card">
        ...
        <form id="form-id" action="{{ route('lokasihilab.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                            ...
                            <select name="provinsi" class="js-example-basic-single custom-select form-control"
                                ...
                                @foreach ($provinsi as $p)
                                    <option value="{{ $p->prov_id }}"
                                        {{ old('provinsi') == $p->prov_name ? 'selected' : '' }}>
                                        {{ $p->prov_name }}
                                    </option>
                                @endforeach
                            </select>
