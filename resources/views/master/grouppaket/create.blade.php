<x-app-layout>
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Tambah Group Paket Laboratorium</h4>
    ...
    <div class="card">
        ...
        <form id="myForm" action="{{ route('grouppaket.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img id="preview" class="mt-2 ml-5 rounded"
